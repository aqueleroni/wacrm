...
const SECURITY_HEADERS = [
  ...
  },
  {
    ...
    value: [
      ...
      // connect.facebook.net — Facebook JS SDK (WhatsApp Embedded Signup).
      ...
      "font-src 'self' data:",
      // Supabase REST + realtime (WSS). Facebook domains are for the
      // client-side JS SDK / Embedded Signup dialog telemetry — Graph
      // API calls for messaging still happen server-side only.
      "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://www.facebook.com https://connect.facebook.net https://graph.facebook.com",
      // FB.login / Embedded Signup may use iframes on facebook.com.
      "frame-src 'self' https://www.facebook.com https://*.facebook.com https://*.fbcdn.net",
