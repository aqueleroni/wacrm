export const inbox = {
  ...
  composer: {
    draftHint: 'Toque no ✨ para rascunhar uma resposta com IA — você pode editar antes de enviar',
    sessionExpiredHint: 'Sessão de 24 horas expirada. Use um modelo para reengajar.',
    templates: 'Modelos',
    readOnlyPlaceholder: 'Somente leitura — visualizadores podem ver, mas não responder',
  ...
  mediaViewer: {
    ...
    download: "Baixar",
    downloadFailed: "Não foi possível baixar o anexo",
    failed: "Este anexo não está mais disponível",
    imageAlt: "Imagem compartilhada",
    you: "Você",
  },
  actions: {
  ...
  templatePicker: {
    sendTemplate: 'Enviar modelo',
    fillPlaceholders: 'Preencha os placeholders para renderizar este modelo. A Meta exige que todas as variáveis estejam definidas.',
    pickTemplate: 'Escolha um modelo WhatsApp aprovado para enviar a este contato.',
