...
export function AccountAccessAlert() {
  ...
  return (
    <Alert variant="destructive" className="mb-4">
      <TriangleAlert />
      <AlertTitle>
        {accountStatus === "unlinked" ? t("common.accountAccess.unlinkedTitle") : t("common.accountAccess.errorTitle")}
      </AlertTitle>
      <AlertDescription>
        {accountStatus === "unlinked" ? t("common.accountAccess.unlinkedBody") : t("common.accountAccess.errorBody")}
        {accountStatusDetail ? (
