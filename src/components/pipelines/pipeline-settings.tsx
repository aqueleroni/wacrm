        ...
        {showDeleteConfirm ? (
          <div className="py-4">
            <div className="flex items-center gap-3 rounded-lg border border-red-500/30 bg-red-500/10 p-4">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-muted-foreground">
                  {t("pipelines.settings.deleteWarning")}
                </p>
              </div>
            </div>
            <div className="mt-4 flex justify-end gap-2">
              ...
              >
                {deleting ? t("common.actions.deleting") : t("pipelines.settings.deleteButton")}
              </Button>
            </div>
          </div>
        ) : (
          <>
            <div className="grid gap-4 py-2">
              <div className="grid gap-2">
                <Label className="text-muted-foreground">{t("pipelines.settings.nameLabel")}</Label>
                <Input
                  value={name}
            ...
            <DialogFooter className="border-border bg-popover/50">
              ...
              >
                {saving ? t("common.actions.saving") : t("pipelines.deal.saveChanges")}
              </Button>
            </DialogFooter>
          </>
        )}
  ...
  return (
    ...
    >
      <button
        ...
        aria-label={t("pipelines.settings.dragReorder")}
      >
