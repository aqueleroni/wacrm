  ...
  switch (node.node_type) {
    case "start":
      return (
        <NextNodeRow
          ...
          label={t("flows.forms.advancesTo")}
        />
      );
    ...
    case "send_message":
      return (
        <>
          <TextRow
            label={t("flows.forms.textToCustomer")}
    ...
    case "collect_input":
      return (
        <>
          <TextRow
            label={t("flows.forms.promptToCustomer")}
          ...
          <div>
            ...
            <Input
              ...
              placeholder={t("flows.forms.varKeyPlaceholder")}
              className="bg-muted font-mono text-xs"
            />
            <p className="mt-1 text-[10px] text-muted-foreground">
              {t("flows.forms.varKeyHint")}
          ...
          <NextNodeRow
            ...
            currentKey={node.node_key}
            onChange={(v) => onUpdateConfig({ next_node_key: v })}
            label={t("flows.forms.afterCapture")}
          />
        </>
      );
    ...
    case "handoff":
      return (
        <TextRow
          label={t("flows.forms.handoffNote")}
...
function SendButtonsForm({
  ...
  return (
    <>
      <TextRow
        label={t("flows.forms.bodyText")}
        value={cfg.text ?? ""}
        onChange={(v) => onUpdateConfig({ text: v })}
        rows={3}
      />
      <TextRow
        label={t("flows.forms.footerOptional")}
            ...
            >
              {showAdvanced && (
                <Input
                  ...
                  placeholder={t("flows.forms.replyId")}
                  className="bg-muted font-mono text-xs"
                />
              )}
              <Input
                ...
                placeholder={t("flows.forms.buttonTitle")}
                className="bg-muted"
                maxLength={20}
              />
              <NodeKeySelect
                ...
                placeholder={t("flows.forms.nextNode")}
              />
              <Button
                variant="ghost"
                size="sm"
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
        <TextRow
          label={t("flows.forms.buttonLabel")}
          ...
          >
            <div className="mb-2 flex items-center gap-2">
              <Input
                ...
                placeholder={t("flows.forms.sectionTitle", { index: sIdx + 1 })}
              ...
              {sections.length > 1 && (
                <Button
                  ...
                  aria-label={t("flows.forms.removeSection")}
                >
                  <Trash2 className="h-3.5 w-3.5" />
                </Button>
              )}
            ...
            {section.rows.map((row, rIdx) => (
              ...
              >
                ...
                <Input
                  ...
                  placeholder={t("flows.forms.rowTitle")}
                  className="bg-muted"
                  maxLength={24}
                />
                <NodeKeySelect
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
        ...
        <div className="md:col-span-2">
          ...
          {subject === "tag" && tags.length > 0 ? (
            ...
            >
              <SelectTrigger className="bg-muted">
                <SelectValue placeholder={t("flows.forms.pickTag")} />
              </SelectTrigger>
              <SelectContent>
                {tags.map((t) => (
            ...
            >
              <SelectTrigger className="bg-muted">
                <SelectValue placeholder={t("flows.forms.pickField")} />
              </SelectTrigger>
              <SelectContent>
  ...
  return (
    <>
        ...
        <div>
          ...
          {tags.length > 0 ? (
            ...
            <Input
              ...
              placeholder={t("flows.forms.tagUuidPlaceholder")}
              className="bg-muted font-mono text-xs"
            />
          )}
        </div>
      ...
      <NextNodeRow
        ...
        currentKey={currentKey}
        onChange={(v) => onUpdateConfig({ next_node_key: v })}
        label={t("flows.forms.thenAdvance")}
      />
    </>
  );
}
...
function SendMediaForm({
  ...
  const handleFile = useCallback(
    async (file: File) => {
      ...
      try {
        ...
        toast.success(t("flows.toast.uploaded"));
      } catch (err) {
        const msg =
          err instanceof Error ? err.message : t("flows.toast.uploadFailed");
        toast.error(msg);
      } finally {
        setUploading(false);
      }
  ...
  return (
    <>
        ...
        {cfg.media_url ? (
          <div className="flex items-center gap-2 rounded-md border border-border bg-muted px-3 py-2 text-xs">
            ...
            <button
              ...
              aria-label={t("flows.forms.removeFile")}
              disabled={uploading}
            >
      ...
      <TextRow
        label={t("flows.forms.captionOptional")}
        value={cfg.caption ?? ""}
      ...
      {isDocument && (
        <div>
          ...
          <Input
            ...
            placeholder={t("flows.forms.filenamePlaceholder")}
            className="bg-muted text-xs"
          />
        </div>
      )}
      ...
      <NextNodeRow
        ...
        currentKey={currentKey}
        onChange={(v) => onUpdateConfig({ next_node_key: v })}
        label={t("flows.forms.afterSending")}
      />
    </>
  );
}
