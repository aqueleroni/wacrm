    ...
    <div className="flex flex-col gap-1.5 px-6 pt-5">
      <div className="flex flex-wrap items-center gap-3">
        <button
          ...
          title={t("flows.editor.backTitle")}
          aria-label={t("flows.editor.backTitle")}
        ...
        <input
          ...
          spellCheck={false}
          aria-label={t("flows.editor.namePlaceholder")}
        ...
        {dirty && (
          <span
            ...
            title={t("flows.editor.editedTitle")}
            aria-live="polite"
          >
        ...
        <div className="ml-auto flex flex-wrap items-center gap-1.5">
          ...
          {state.status === "active" ? (
            ...
            <Button
              ...
              title={
                !canActivate ? t("flows.editor.fixBeforeActivate") : undefined
              }
            >
              {activating ? (
                <Loader2 className="h-3.5 w-3.5 animate-spin" />
      ...
      <input
        ...
        aria-label={t("flows.editor.descriptionPlaceholder")}
